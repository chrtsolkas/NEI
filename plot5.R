...
png("plot5.png", height = 480, width = 640)
...
SCC %>%
  ...
  labs(x = "Year", y = "Total emissions (in tons)", 
       title = expression("Total PM"[2.5] * " emission from motor vehicle sources in the Baltimore City")) +
...
# Answer: Emissions from motor vehicle sources in the Baltimore City have significantly 
